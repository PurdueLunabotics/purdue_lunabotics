...
StepperMotor MyMotor(0x3, BLD305S, 255, 255);
...
void setup(void) {
  ...
  MyMotor.begin();
  // MyMotor.write_register(0x00A6, 0x03);
  // MyMotor.write_register(0x00F6, 0x05);
  // MyMotor.write_register(0x80FF, 0x55AA);

  MyMotor.move_at_speed(200);
}

void loop(void) {
  MyMotor.move_at_speed(300);
  // Serial.println();
