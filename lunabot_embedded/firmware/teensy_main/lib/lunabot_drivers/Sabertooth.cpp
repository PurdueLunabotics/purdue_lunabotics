...
void Sabertooth::setMinVoltage(byte value) const { command(2, (byte)min(value, 120)); }

void Sabertooth::setMaxVoltage(byte value) const { command(3, (byte)min(value, 127)); }
...
void Sabertooth::setDeadband(byte value) const { command(17, (byte)min(value, 127)); }

void Sabertooth::setRamping(byte value) const { command(16, (byte)constrain(value, 0, 80)); }
