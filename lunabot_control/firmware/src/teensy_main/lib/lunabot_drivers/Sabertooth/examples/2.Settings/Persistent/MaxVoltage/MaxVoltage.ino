...
// WARNING: This sample makes changes that will persist between restarts AND in
// all modes.
//          The values in this sample are specifically for the Sabertooth 2x25,
//          and may not have the same effect on other models.
...
void setup() {
    ...
    // -- at 16V they tend to shut off. Here, if the voltage climbs above 14V
    // due to regenerative braking, the Sabertooth will go into hard brake
    // instead. While this is occuring, the red Error LED will turn on.
    //
