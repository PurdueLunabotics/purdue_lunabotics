...
def launch_setup(context):
    ...
    robot_state_publisher_node = Node(
        ...
        parameters=[{'use_sim_time': True, 'robot_description': Command(['xacro ', robot_desc_path, ' robot_name:=', entity_name])}],
        output="screen"
    )
    ...
    joint_state_publisher_node = Node(
            ...
            namespace=entity_name,
            parameters=[{'use_sim_time': True, 'robot_description': Command(['xacro ', robot_desc_path, ' robot_name:=', entity_name]), 'source_list': [f"{ns}/joint_states"]}],
        output="screen"
    )
