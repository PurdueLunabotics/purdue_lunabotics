...
class Renderer:
    def __init__(
        ...
        self.screen = pygame.display.set_mode(
            (field_length * pixels_per_meter, field_width * pixels_per_meter)
        )
    ...
    def render(self, robot_x, robot_y, angle):
        ...
        rotated_top_left = (
            robot_x + top_left[0] * cos - top_left[1] * sin,
            robot_y + top_left[0] * sin + top_left[1] * cos,
        )
        rotated_bottom_left = (
            robot_x + bottom_left[0] * cos - bottom_left[1] * sin,
            robot_y + bottom_left[0] * sin + bottom_left[1] * cos,
        )
        rotated_top_right = (
            robot_x + top_right[0] * cos - top_right[1] * sin,
            robot_y + top_right[0] * sin + top_right[1] * cos,
        )
        rotated_bottom_right = (
            robot_x + bottom_right[0] * cos - bottom_right[1] * sin,
            robot_y + bottom_right[0] * sin + bottom_right[1] * cos,
        )
