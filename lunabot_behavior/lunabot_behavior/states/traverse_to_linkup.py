...
class TraverseToLinkup(Traverse):
  ...
  def linkup_cb(self, linkup: Linkup):
    ...
    self.goal.pose.orientation.x, self.goal.pose.orientation.y, self.goal.pose.orientation.z, self.goal.pose.orientation.w = quaternion_from_euler(0, 0, atan2(y, x))
