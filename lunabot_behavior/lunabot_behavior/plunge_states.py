...
class plunge_state(State):
    def setup(self, manager: Node):
        self.plunge_pub = manager.create_publisher(Int32, "plunge", 10)
    ...
    def periodic(self) -> None | Events:
        ...
        if abs(self.sensors.act_right_curr) > self.LIN_ACT_CURR_THRESHOLD:
            return Events.SUCCESS
        return None
            
    
    def exit(self):
        self.plunge_pub.publish(Int32(0))
